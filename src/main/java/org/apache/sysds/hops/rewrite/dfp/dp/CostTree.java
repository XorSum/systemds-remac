...
//                            }
                    ...
                    System.out.println("0.1 " + lRange + " " + rRange + " " + lops.size() + " " + rops.size() + " " + acNode.operatorNodes.size());
...
//                if (singleCse.name.equals("{h t(a) a h g }")) {
//                    System.out.println(MAINTAINER.getCseState(singleCse)+" "+singleCse);
//                }
            }
